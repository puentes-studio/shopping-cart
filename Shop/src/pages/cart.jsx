...
import CartTile from "../components/cart-tile/index.cart.tile";
    ...
    <div className="flex justify-center">
      {cart && cart.length ? (
        ...
        <div className="min-h-[80vh] flex flex-col items-center justify-center">
          ...
          <Link to="/">
            <button className="bg-cyan-500 hover:bg-cyan-600  text-white border-2 rounded-md font-bold px-4 py-1">
              SHOP NOW
            </button>
          </Link>
        </div>
